...
uses
  MainModule, uniGUIApplication, UnitFODaftar;
...
begin
  frmFODaftar.tgl_hasil := dtTanggal.DateTime;
  frmFODaftar.catatan_hasil := mmCatatan.Lines.Text;
  Close;
end;
...
begin
  ...
  dtTanggal.DateTime := frmFODaftar.tgl_hasil;
  mmCatatan.Lines.Text := frmFODaftar.catatan_hasil;
end;
