...
type
  TfrmCetakHasil = class(TUniForm)
    ...
    procedure UniDBGrid1KeyPress(Sender: TObject; var Key: Char);
    procedure UniDBGrid1MouseEnter(Sender: TObject);
...
procedure TfrmCetakHasil.UniDBGrid1CellClick(Column: TUniDBGridColumn);
begin
  UniDBGrid1SelectionChange(self);
end;

procedure TfrmCetakHasil.UniDBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  UniDBGrid1SelectionChange(self);
end;

procedure TfrmCetakHasil.UniDBGrid1MouseEnter(Sender: TObject);
begin
  UniDBGrid1SelectionChange(self);
end;
