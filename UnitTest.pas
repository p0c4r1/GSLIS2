...
type
  TfrmTest = class(TUniForm)
    ...
    cbKelompok: TUniDBLookupComboBox;
    cbInduk: TUniDBLookupComboBox;
    UniEdit2: TUniEdit;
    UniEdit3: TUniEdit;
    UniLabel3: TUniLabel;
    UniLabel4: TUniLabel;
    ...
    QLayananid: TFDAutoIncField;
    QLayanannama: TStringField;
    ...
    procedure cbLayananChangeValue(Sender: TObject);
  private
...
procedure TfrmTest.cbLayananChangeValue(Sender: TObject);
begin
cbKelompok.Clear;
  if QKelompok.Active then
    QKelompok.Active := False;
  QKelompok.ParamByName('layanan_id').Value := QLayanan.FieldByName('id')
    .AsInteger;
  QKelompok.Active := True;
end;
